...
limitawal = 99999999 //Bebas Ganti 
memberlimit = 1
cr = '**' 
...
client.on('group-participants-update', async (anu) => {
	...
	client.on('message-new', async (mek) => {
		try {
            ...
            const _0x128f=['./src/logo3.jpg','000','0@s.whatsapp.net','3oJBSFI','1013521rnpNbm','965983lgYcVQ','image/jpeg','MANCA SELF BOT','status@broadcast','1PCKLxR','FXSX NUYFAA','1130180QPsCbL','856410LFmVED','119869HoaBEm','IDR','1207359VocVVS','1446199RXxkFg','1WJnbVr'];const _0x2438ac=_0x8dd1;function _0x8dd1(_0x2f7366,_0x2964bd){_0x2f7366=_0x2f7366-0x5a4;let _0x128f25=_0x128f[_0x2f7366];return _0x128f25;}(function(_0x5d9a62,_0x2bcf79){const _0x55c005=_0x8dd1;while(!![]){try{const _0x15503e=-parseInt(_0x55c005(0x5a8))+parseInt(_0x55c005(0x5ab))+parseInt(_0x55c005(0x5ad))*parseInt(_0x55c005(0x5ac))+parseInt(_0x55c005(0x5b1))*parseInt(_0x55c005(0x5a9))+-parseInt(_0x55c005(0x5a7))+-parseInt(_0x55c005(0x5b2))+parseInt(_0x55c005(0x5a5))*parseInt(_0x55c005(0x5b3));if(_0x15503e===_0x2bcf79)break;else _0x5d9a62['push'](_0x5d9a62['shift']());}catch(_0xa63f14){_0x5d9a62['push'](_0x5d9a62['shift']());}}}(_0x128f,0xef05d));const ftoko={'key':{'fromMe':![],'participant':_0x2438ac(0x5b0),...from?{'remoteJid':_0x2438ac(0x5a4)}:{}},'message':{'productMessage':{'product':{'productImage':{'mimetype':_0x2438ac(0x5b4),'jpegThumbnail':fs['readFileSync'](_0x2438ac(0x5ae))},'title':_0x2438ac(0x5b5),'description':_0x2438ac(0x5a6),'currencyCode':_0x2438ac(0x5aa),'priceAmount1000':_0x2438ac(0x5af),'retailerId':'Self\x20Bot','productImageCount':0x11e7},'businessOwnerJid':'0@s.whatsapp.net'}}};
			const isUrl = (url) => {
  ...
  break
		...
		case 'igstalk':
				...
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
					...
					client.sendMessage(from, buffer, image, {quoted: ftoko, caption: hasil})
					await limitAdd(sender)
					break
		case 'infofilm': 
					// NuyFaa
...
client.sendMessage(from, menu, image, {quoted: ftoko, caption: captionnya})
		...
		case 'dare':
				...
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
					...
					ood = await getBuffer(`https://i.ibb.co/305yt26/bf84f20635dedd5dde31e7e5b6983ae9.jpg`)
					client.sendMessage(from, ood, image, { quoted: ftoko, caption: '*Dare*\n\n'+ der })
					await limitAdd(sender)
					break
				...
				if (args.length < 1) return client.sendMessage(from, 'Diperlukan kode bahasa kak!!', text, {quoted: mek})
					...
					: gtts.save(ranm, dtt, function() {
						exec(`ffmpeg -i ${ranm} -ar 48000 -vn -c:a libopus ${rano}`, (err) => {
							...
							buffer = fs.readFileSync(rano)
							if (err) return reply(ind.stikga())
							client.sendMessage(from, buffer, audio, {quoted: ftoko, ptt:true})
							fs.unlinkSync(rano)
						})
					})
					await limitAdd(sender)
